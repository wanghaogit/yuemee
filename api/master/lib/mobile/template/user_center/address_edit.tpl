 ...
 #con:after{
    ...
    <body style="background: #FAFAFA;">
	    ...
	    <header class="mui-bar mui-bar-nav" style="background-color: white;">
	        ...
	        <h1 class="mui-title" style="font-size: 16px;">编辑地址</h1>
		...
		<div class="mui-card-content" style="margin-top: 60px">
			<div class="mui-input-row" style="background: white; font-size:16px;width: 94%;margin-left: 3%;margin-right: 3%;">
							...
							<input id="title" type="text" class="mui-input-clear" placeholder="请输入收货人姓名" value="{:$data.contacts:}" style="font-size:14px;margin-top:5px;">
			</div>
			<div class="line" style="width: 94%;margin-left: 3%;margin-top: 1px;    background: #fafafa;"></div>
			<div class="mui-input-row" style="background: white; font-size:16px;width: 94%;margin-left: 3%;margin-right: 3%;">
							<label style="margin-top:5px;">所在地区</label>
							<input readonly="readonly" id="liveProvince" type="text" class="mui-input-clear" placeholder="请选择所在地区" value="{:$data.province:}{:$data.city:}{:$data.country:}" style="font-size:14px;margin-top:5px;">
							<input type="hidden" value="{:$data.region_id:}" id="region_id"/>
							<input type="hidden" value="{:$id:}" id="addid"/>
			
			</div>
			<div class="line" style="width: 94%;margin-left: 3%;margin-top: 1px;    background: #fafafa;"></div>
			<div class="mui-input-row" style="background: white; font-size:16px;width: 94%;margin-left: 3%;margin-right: 3%;">
							<label style="margin-top:5px;">手机号</label>
							<input id="mobile" type="text" class="mui-input-clear" placeholder="请输入收货人的手机号" value="{:$data.mobile:}" style="font-size:14px;margin-top:5px;">
			</div>
			...
			<div class="mui-input-row" style="background: white; font-size:16px;width: 94%;margin-left: 3%;margin-right: 3%;height: 80px;">
							...
							<textarea id="addre" class="mui-input-clear" placeholder="请输入详细地址" style="font-size:14px;margin-top:5px;">{:$data.address:}</textarea>
			</div>
		...
		/* 本页面临时/初始化专用JS */
		   ...
		   $("#liveProvince").on("tap", function() {
		    ...
		    $("#preservation").on("tap", function(){
				...
				var address=$("#addre").text();
				var contacts=$("#title").val();
				...
				YueMi.API.invoke('profile','update_adderss',addressnew,function(target, request, response){
				
					 console.log(JSON.stringify(response));
					 //分析数据
					 mui.toast('编辑地址成功！');
					 window.location.href = '/mobile.php?call=user_center.address&share_id='+{:$share_id:};
