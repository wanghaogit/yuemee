            ...
            <div class="mui-content">
               <div class="mui-card">
					...
					<div  class="mui-table-p2" >
			        	...
			        	<p class="mui-money" style="margin-bottom: 0;margin-right:0;margin-top: 4%;margin-left: -1%;">￥{:$Attr.Price.Sale:}
			        		<span style="border: none;">￥{:$Attr.Price.Ref:}</span>&nbsp;<img src="{:#URL_RES:}/v1/images/mobile/zhuan.png" style="width: 14px;height: 14px;border: none;margin-left: 5%;margin-top: 2%;"/><span style="border: none;padding: 0;margin-left: -4%;">￥{:$Attr.Rebate.Vip:}</span>
...
<script>
	...
	{  
		...
		if(wechat_userid==0)
		{
		   window.location.href = '/mobile.php?call=runer.login_mobile&share_id={:$share_id:}';
		}
		/*if(address_id<1)
		{
