    ...
    <body style="background-color: #FAFAFA;">
        <div class="mui-content ziima">
            ...
            <header class="mui-bar mui-bar-nav" style="background: #fff;box-shadow: 0 0px 1px #e1e1e1;">
		        <a class="mui-icon mui-pull-left" style="color: #333;margin-right:-3px" onclick="javascript:history.back(-1);"><img src="{:#URL_RES:}/v1/images/mobile/itemnext.png" style="width: 50%;"/></a>
			...
			<div style="position:fixed;bottom:-5px ;width:100%;" onclick="javascript:check1({:$wechat_userid:});">
				<img src="{:#URL_RES:}/v1/images/mobile/button1.png" style="width: 100%;"/>
			</div>
<!--            <nav class="mui-bar mui-bar-tab footer">	
			    <a id="BuyButton" class="mui-tab-item" onclick="javascript:check1({:$wechat_userid:});" style="background-color: #FB342A;width:100%;height:100%;">
...
<script type="text/javascript">
	...
	{
		{:if empty($RegUrl):}
			window.location.href = '/mobile.php?call=mall.order&share_id={:$share_id:}&{:#Z_NOW:}';
		{:else:}
