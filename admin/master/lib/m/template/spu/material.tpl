...
<div>
	<ul class="SimpleList">
		<li {:if $_PARAMS.t == 0:}class="selected"{:/if:}><a href="{:$_URL | common.set_url_param 't',0:}">SPU主图</a></li>
		<li {:if $_PARAMS.t == 1:}class="selected"{:/if:}><a href="{:$_URL | common.set_url_param 't',1:}">SPU素材</a></li>
	</ul>
</div>
<div id="show-img">
...
<table cellspacing="0" cellpadding="0" class="Grid" style="width:1000px;">
	...
	<tr>
		...
		<td>
			{:if $S.status == 0:}
			<a href="/index.php?call=spu.throw_picture&id={:$S.id:}&t={:$_PARAMS.t:}">通过</a>
			<a href="/index.php?call=spu.hit_picture&id={:$S.id:}&t={:$_PARAMS.t:}" style="color:red;">驳回</a>
			{:elseif $S.status == 1:}
