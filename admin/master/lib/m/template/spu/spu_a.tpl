{:include file="_g/header.tpl" Title="库存/在线SPU":}
...
<table border="0" cellspacing="0" cellpadding="0" class="Grid">
	...
	{:foreach from=$data->Data value=v:}
		<tr>
			...
			<td align="center">
				{:echo 1 | boolean.iconic:}
			</td>
			<td>
				<a onclick="operate_material({:$v.id:})"><i class="fas fa-film"></i>素材管理</a>
				<a href="/index.php?call=spu.spu_info&spu_id={:$v.id:}">SPU详情</a>
				<a href="/index.php?call=spu.edit_spu_info&id={:$v.id:}&ty=a">编辑</a>
				<a onclick="copy_to_spu({:$v.id:})"><i class="fas fa-film"></i>复制</a>
			</td>
		</tr>
	{:/foreach:}
...
<script type="text/javascript">
	...
	function copy_to_spu(spu_id){
		YueMi.API.Admin.invoke('mall', 'copy_to_spu', {
			__access_token: '{:$User->token:}',
			spu_id : spu_id
		}, function (t, q, r) {
			alert('复制完成');
