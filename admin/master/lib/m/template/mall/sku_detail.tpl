...
<br />
		...
		<table>
			...
			<tr>
				<td class="td1">状态</td>
				<td class="td2">{:if $data.status == 1:}上架{:else:}下架{:/if:}</td>
				<td class="td1">货号</td>
			...
			<tr>
				...
				<td class="td1">无邀请码会员的价格</td>
				<td class="td2">{:$data.price_vip:}</td>
			</tr>
			<tr>
			...
			<!--<tr>
				...
				<td class="td2" colspan="3"><a href="{:$data.video:}">{:$data.video:}</a></td>
			</tr>-->
			<tr class="info">
				<td class="td1">详情</td>
				<td class="td2" colspan="3">{:$data.intro:}</td>
			</tr>
		</table>
